# VolumeCube — deferred items (explicitly out of scope for v1)

- E1.31 / sACN transport
- MIDI input
- Webcam / computer-vision input
- OSC input
- Gamepad / sensor inputs
...
- Cmd/Ctrl+K command palette (Phase 5 deferrable)
